...
// ST4NK! Ticket Beta v0.1 - admin.catagory_delete.php
...
$catagory_id = mysqlclean($_GET, "catagory_id", 50, $connection);
...
$query = "DELETE FROM st4nkticket_catagories WHERE catagory_id = '{$catagory_id}'";
