...
function selectDistinctCatagory ($connection, $tableName, $attributeName, $pulldownName, $defaultValue)

{
	...
	print "\n\t<option selected value=\"Select from list:\">Select from list:</option>";
