...
// ST4NK! Ticket Beta v0.1 - admin.ticket_global_sort.php
...
$sort_column = mysqlclean($_POST, "sort_column", 20, $connection);
$sort_order = mysqlclean($_POST, "sort_order", 20, $connection);
$sort_table = mysqlclean($_POST, "sort_table", 20, $connection);
$rows_page = mysqlclean($_POST, "rows_page", 5, $connection);
...
$_SESSION["rows_page"] = $rows_page;
		
if (!mysql_select_db($databaseName, $connection))
	showerror();

// RETURN TO THE GLOBAL TICKET PAGE

if ($sort_table == 'global')
	header("Location: admin.ticket_global.php");
else
