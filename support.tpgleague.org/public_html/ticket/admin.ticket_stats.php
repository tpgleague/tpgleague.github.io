...
print "<tr><td width=200>&nbsp</td><td width=200><p>&nbsp</p></td><td width=400></td></tr>";
print "<tr><td colspan=3><p><b>Ticket Stats</b></p></td></tr>\n";
print "<tr><td colspan=3><p>&nbsp</p></td></tr>\n";

// find the total number of tickets

$query1 = mysql_query ("SELECT * FROM st4nkticket_tickets");
$total_tickets = mysql_num_rows($query1);
print "<tr><td bgcolor=#BFD8BC><p>Total tickets in the database:</td><td align=left bgcolor=#BFD8BC><p>$total_tickets</p></td><td></td></tr>";
...
print "<tr><td bgcolor=#CCFFCC><p>Total number of pending tickets:</td><td align=left bgcolor=#CCFFCC><p>$pending_tickets</p></td><td></td></tr>";
...
print "<tr><td bgcolor=#BFD8BC><p>Total number of active tickets:</td><td align=left bgcolor=#BFD8BC ><p>$active_tickets</p></td><td></td></tr>";
...
print "<tr><td bgcolor=#CCFFCC><p>Total number of closed tickets:</td><td align=left bgcolor=#CCFFCC><p>$closed_tickets</p></td><td></td></tr>";

// CALCULATE CATAGORY STATS

print "<tr><td colspan=3><p>&nbsp</p></td></tr>\n";
print "<tr><td colspan=3><p><b>Catagory Stats</b></p></td></tr>\n";
print "<tr><td colspan=3><p>&nbsp</p></td></tr>\n";
print "<tr><td><p><u>Catagory</u></p></td><td><p><u>Tickets</u></p></td><td></td></tr>\n";
print "<tr><td colspan=3><p>&nbsp</p></td></tr>\n";
...
print "<tr><td bgcolor=$row_color><p>$catagory_name</p></td><td bgcolor=$row_color><p>$catagory_tickets</p></td><td></td></tr>\n";
...
print "<tr><td colspan=3><p>&nbsp</p></td></tr>\n";
print "<tr><td colspan=3><p><b>Helper Stats</b></p></td></tr>\n";
print "<tr><td colspan=3><p>&nbsp</p></td></tr>\n";
print "<tr><td><p><u>Helper</u></p></td><td><p><u>Tickets</u></p></td><td></td></tr>\n";
print "<tr><td colspan=3><p>&nbsp</p></td></tr>\n";
...
print "<tr><td bgcolor=$row_color><p>$helper_handle</p></td><td bgcolor=$row_color><p>$helper_tickets</p></td><td></td></tr>\n";
