...
// ST4NK! Ticket Beta v0.1 - admin.catagory_insert.php
...
$catagory_name = mysqlclean($_POST, "catagory_name", 50, $connection);
...
$query = "INSERT INTO st4nkticket_catagories VALUES (NULL, '{$catagory_name}')";
