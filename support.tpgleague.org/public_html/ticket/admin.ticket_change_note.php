...
// ST4NK! Ticket Beta v0.1 - admin.ticket_change_note.php
...
$ticket_id = mysqlclean($_GET, "ticket_id", 10, $connection);
$note_id = mysqlclean($_GET, "note_id", 7, $connection);
$note_private = mysqlclean($_GET, "note_private", 5, $connection);

// UPDATE THE CATAGORY ENTRY

$query = "UPDATE st4nkticket_notes SET note_private = '{$note_private}' WHERE note_id = '{$note_id}'";
