...
<td><input type="password" name="newpass" autocomplete="off" size="40" maxlength="20" value="<?php echo $_SESSION['userdata']['cleanpass']; ?>" onkeyup="javascript:hesk_checkPassword(this.value)" />
</td>
</tr>
<tr>
...
{
	?>
    <label><input type="radio" name="isadmin" value="1" onchange="Javascript:hesk_toggleLayerDisplay('options')" <?php if ($_SESSION['userdata']['isadmin']) echo 'checked="checked"'; ?> /> <?php echo $hesklang['yes'].' '.$hesklang['admin_can']; ?></label><br />
	<label><input type="radio" name="isadmin" value="0" onchange="Javascript:hesk_toggleLayerDisplay('options')" <?php if (!$_SESSION['userdata']['isadmin']) echo 'checked="checked"'; ?> /> <?php echo $hesklang['no'].' '.$hesklang['staff_can']; ?></label>
    <?php
}
else
{
...
if ($hesk_settings['autoassign'])
{
	?>
	<tr>
	<td width="200" style="text-align:right"><?php echo $hesklang['opt']; ?>:</td>
	<td><label><input type="checkbox" name="autoassign" value="Y" <?php if ( ! isset($_SESSION['userdata']['autoassign']) || $_SESSION['userdata']['autoassign'] == 1 ) {echo 'checked="checked"';} ?> /> <?php echo $hesklang['user_aa']; ?></label></td>
	</tr>
	<?php
}
?>
...
function edit_user()
{
	...
	<td><input type="password" name="newpass" autocomplete="off" size="40" maxlength="20" value="<?php echo $_SESSION['userdata']['cleanpass']; ?>" onkeyup="javascript:hesk_checkPassword(this.value)" /></td>
	</tr>
	<tr>
